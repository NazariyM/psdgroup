        ...
        function init() {
          var geoMap = new ymaps.Map('map', {
            ...
            controls: []
              ...
              BalloonContentLayout = ymaps.templateLayoutFactory.createClass('<div class="geo__box">' + '<h5 class="geo__box-title">{{properties.name}}</h5>' + '<p class="geo__box-descr">{{properties.description}}</p> ' + '<a class="geo__box-btn btn" href="#!">смотреть услуги</a>' + '</div>');

          // begin countries
          var countries = new ymaps.GeoObjectCollection({}, {
          ...
          var Kazakhstan = new ymaps.Placemark([51.39567825, 71.90857082], {
          ...
          var Uzbekistan = new ymaps.Placemark([40.93894161, 69.79919582], {
            name: 'Турция, г. Стамбул',
            description: 'Компания специализируется на оказании юридических услуг как физическим лицам, так и юридическим лицам.'
          });

          var China = new ymaps.Placemark([41.10722065, 114.79621997], {
            name: 'Турция, г. Стамбул',
            description: 'Компания специализируется на оказании юридических услуг как физическим лицам, так и юридическим лицам.'
          });

          var abuDhabi = new ymaps.Placemark([23.82027108, 53.87626207], {
            name: 'Турция, г. Стамбул',
            description: 'Компания специализируется на оказании юридических услуг как физическим лицам, так и юридическим лицам.'
          });

          var France = new ymaps.Placemark([44.27543105, 1.93849925], {
            name: 'Турция, г. Стамбул',
            description: 'Компания специализируется на оказании юридических услуг как физическим лицам, так и юридическим лицам.'
          });

          var Japan = new ymaps.Placemark([38.03921768, 139.39943675], {
            name: 'Турция, г. Стамбул',
            description: 'Компания специализируется на оказании юридических услуг как физическим лицам, так и юридическим лицам.'
          });

          var Turkey = new ymaps.Placemark([41.03283332, 33.40334300], {
            name: 'Турция, г. Стамбул',
            description: 'Компания специализируется на оказании юридических услуг как физическим лицам, так и юридическим лицам.'
          });

          var Ukraine = new ymaps.Placemark([48.76147206, 35.68849925], {
            name: 'Украина, г. Харьков',
            description: 'Компания специализируется на оказании юридических услуг как физическим лицам, так и юридическим лицам.'
          });

          var Belarus = new ymaps.Placemark([54.64816195, 27.60256175], {
            name: 'Беларусь, г. Гомель',
            description: 'Компания специализируется на оказании юридических услуг как физическим лицам, так и юридическим лицам.'
          });

          var Russia = new ymaps.Placemark([55.75399400, 37.62209300], {
            name: 'Россия, г. Москва',
            description: 'Компания специализируется на оказании юридических услуг как физическим лицам, так и юридическим лицам.'
          });

          countries.add(Russia).add(Ukraine).add(Belarus).add(Turkey).add(France).add(Japan).add(abuDhabi).add(China).add(Uzbekistan).add(Kazakhstan);
...
var ContactMap = exports.ContactMap = function () {
  function ContactMap() {
    ...
    value: function init() {
      ...
      function initContactMap() {
        ...
        function init() {
          ...
          var ourPlace = new ymaps.Placemark(contactMap.getCenter(), {}, {
            iconLayout: 'default#image',
            iconImageHref: 'static/img/icons/shield.png',
            iconImageSize: [32, 42],
            balloonOffset: [13, 192]
...
var _maps = __webpack_require__(127);
...
var _selectInit = __webpack_require__(335);

var _cTabs = __webpack_require__(339);
...
var _particles = __webpack_require__(348);

var _particles2 = _interopRequireDefault(_particles);

var _vintagePopup = __webpack_require__(349);

var _vintagePopup2 = _interopRequireDefault(_vintagePopup);

var _objectFitImages = __webpack_require__(350);

var _objectFitImages2 = _interopRequireDefault(_objectFitImages);

var _fancybox = __webpack_require__(351);
...
var _initDot = __webpack_require__(353);
...
var Flatpickr = __webpack_require__(355);
var Russian = __webpack_require__(356).ru;
...
/** canvas particles */
(function () {
  var grayParticles = $('#js-gray-particles').length;
...
function scrollDown(el, offset) {
  el.on('click', function () {
    var $that = $(this);
    var $section = $that.closest('section').next().offset().top - offset;
    _helpers.$scrolledElements.animate({ scrollTop: $section }, 700);
    $that.fadeOut(500);
  });
}

var $btnMouse = $('.anim-mouse');
scrollDown($btnMouse, 230);

(function () {
  var $scrollToSection = $('.js-scroll-next');
  $scrollToSection.on('click', function () {
    var $that = $(this);
    var $hiddenBlock = $that.closest('section').next('[data-item="hidden"]');
    $hiddenBlock.slideDown(500);
    var $section = $that.closest('section').next().offset().top - 144;
    _helpers.$scrolledElements.animate({ scrollTop: $section }, 700);
  });
})();

/** display hidden items */
var $showBtn = $('.js-show-btn');
$showBtn.on('click', function (ev) {
  ev.preventDefault();
  var $that = $(this);
  var $siblingsItems = $that.siblings('[data-item="hidden"]');
  var $scrollItem = $siblingsItems.first();
  $siblingsItems.slideDown();
  _helpers.$scrolledElements.animate({ scrollTop: $scrollItem.offset().top - 159 }, 700);
  $that.fadeOut();
});
...
!function(e){ true?!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(92)], __WEBPACK_AMD_DEFINE_FACTORY__ = (e),
...
var _slickCarousel = __webpack_require__(342);
...
(function () {
  ...
  if (_helpers.Resp.isNotMobile) _helpers.$window.on('scroll', toggleHeaderScroll);
})();
...
(function () {
  ...
  $navBtn.on('click', function (e) {
    var $this = $(this);
    _helpers.$header.toggleClass('is-active');
  ...
  _helpers.$window.on('resize', function () {
    _helpers.$header.removeClass('is-active');
...
var _ScrollReveal = __webpack_require__(346);

var _ScrollReveal2 = _interopRequireDefault(_ScrollReveal);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var scrollContainer = '[data-fade-on-scroll]';
var scrollLine = '[data-fade-line]';
var scrollZoom = '[data-fade-zoom]';
var scrollDelay = '[data-fade-delay]';
var scrollLeft = '[data-fade-left]';
var scrollRight = '[data-fade-right]';
...
function blockToggle() {
  var $togglingBlock = $('.js-toggle-block');

  $togglingBlock.each(function () {
    var $thisBlock = $(this);
    var $toggleTitle = $thisBlock.find('.js-toggle-title');
    var $toggleBtn = $thisBlock.find('.js-toggle-btn');
    var $toggleContent = $thisBlock.find('.js-toggle-content');
